...
import {withUseAppColours} from '../../config'

const DIMENSIONS = Dimensions.get('window')

class SlideOverPane extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  getStyles() {
    const appColours = this.props.appColours
...
export default withUseAppColours(SlideOverPane)
